...
{
	// Genode::log("CoreTimeClockSource: ", read<ControlRegister::CoreTimeClockSource>());
	// Genode::log("TimerIncrement     : ", read<ControlRegister::TimerIncrement>());
	// Genode::log("CoreTimerPrescaler : ", read<CoreTimerPrescaler>());
